package com.example.safetyaid.Utils;
...
import com.example.safetyaid.App;
...
public class BluetoothHelper implements BluetoothListener
{
    ...
    public void initializeBluetooth(OnBluetoothSupportedCheckListener listener) {
        ...
        if (!App.getAppContext().getPackageManager().hasSystemFeature(PackageManager.FEATURE_BLUETOOTH_LE)) {
